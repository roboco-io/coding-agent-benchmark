...
| M-18 | Claude Code를 DeepSeek Anthropic 호환 엔드포인트로 `deepseek-flash`(V4.1-Flash)·`deepseek-v4-pro`에 직결하면(thinking 기본값) 격리·무교란 랄프 루프로 RealWorld 백엔드(Hurl 13/13·154/154)를 상한 30 iter·4h 안에 무개입 완주할 수 있다 (EN·KO 정본 각 n=3, 완주율 판정·과금 배제) | 진행중 | [EXP-025](../experiments/025-deepseek-direct/README.md) |
